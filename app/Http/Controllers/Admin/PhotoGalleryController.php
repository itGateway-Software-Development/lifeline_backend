...
class PhotoGalleryController extends Controller
{
    ...
    public function create() {
        ...
        return view('admin.photo_gallery.create', compact('years'));
    }
    ...
    public function show(PhotoGallery $photoGallery) {
        ...
        return view('admin.photo_gallery.show', compact('photo_gallery'));
    }
    ...
    public function edit(PhotoGallery $photoGallery) {
        ...
        return view('admin.photo_gallery.edit', compact('years', 'photo_gallery'));
    }
